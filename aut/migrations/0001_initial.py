# Generated by Django 3.1.2 on 2021-01-04 18:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testr_status', models.CharField(blank=True, choices=[('n', 'no run yet'), ('p', 'pass'), ('f', 'fail')], help_text='TestRun Ergebnis', max_length=1)),
                ('testr_dauer', models.TimeField(blank=True, null=True)),
