# Generated by Django 3.1.2 on 2021-01-24 11:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testc_name', models.CharField(blank=True, max_length=128, null=True)),
                ('testc_kommentar', models.CharField(blank=True, max_length=128, null=True)),
                ...
                ('testc_beschreibung', models.CharField(blank=True, max_length=128, null=True)),
                ('testc_vorbedingung', models.CharField(blank=True, max_length=128, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('testr_beschreibung', models.CharField(blank=True, max_length=128, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gruppennummer', models.CharField(blank=True, choices=[('1', 'Gruppe 1'), ('2', 'Gruppe 2'), ('3', 'Gruppe 3'), ('4', 'Gruppe 4'), ('5', 'Gruppe 5'), ('6', 'Gruppe 6'), ('7', 'Gruppe 7'), ('8', 'Gruppe 8'), ('9', 'Gruppe 9')], max_length=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('schritt_ergebnis', models.CharField(blank=True, choices=[('p', 'pass'), ('f', 'fail')], default=('f', 'fail'), max_length=1, null=True)),
                ('schritt_schritte', models.CharField(blank=True, max_length=128, null=True)),
                ('schritt_erwartetesergebnis', models.CharField(blank=True, max_length=128, null=True)),
