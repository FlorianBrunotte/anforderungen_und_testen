"""
Django settings for anforderungenundtesten project.
...
#SECRET_KEY = 'y$umg)chbn=dy##w)bthxcw!6fdfqj$#b^hzh0io*j7-l2@&pd'
import os
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'y$umg)chbn=dy##w)bthxcw!6fdfqj$#b^hzh0io*j7-l2@&pd')
...
ROOT_URLCONF = 'anforderungenundtesten.urls'
...
WSGI_APPLICATION = 'anforderungenundtesten.wsgi.application'


# Database
# https://docs.djangoproject.com/en/3.1/ref/settings/#databases
#das hier als Quelle nehmen ^
